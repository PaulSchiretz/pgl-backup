...
func (t *compressTask) compressBackup(absToCompressPath, absToCompressContentPath string) error {
	...
	switch t.format {
	case Zip:
		comp = newZipCompressor(t.dryRun, t.format, t.level, t.ioBufferPool, t.ioBufferSize, t.readAheadLimiter, t.readAheadLimit, t.readAheadPool, t.numCompressWorkers, t.metrics)
	case TarGz, TarZst:
		comp = newTarCompressor(t.dryRun, t.format, t.level, t.ioBufferPool, t.ioBufferSize, t.readAheadLimiter, t.readAheadLimit, t.readAheadPool, t.numCompressWorkers, t.metrics)
	default:
